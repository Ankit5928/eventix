...
export default function EventDetailPage() {
    ...
    return (
      <div className="premium-page-container flex items-center justify-center bg-background">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <p className="text-[#FF3333] font-bold tracking-[0.3em] uppercase text-xs animate-pulse">
  ...
  return (
    <div className="premium-page-container pb-24 overflow-y-auto bg-background">
      ...
      <div className="absolute top-0 right-0 w-[60%] h-[60%] bg-[#FF0000]/5 rounded-full blur-[160px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[40%] h-[40%] bg-[#8B0000]/5 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="container mx-auto px-6 -mt-48 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            <div className="animate-fade-in-up space-y-6">
              <div className="flex items-center gap-4">
                ...
                <span className="text-[#FF3333] font-black uppercase tracking-[0.4em] text-[10px]">
                  Elite Access Portfolio
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-1 p-1 bg-white/[0.03] backdrop-blur-2xl rounded-3xl border border-white/10 shadow-2xl">
                <div className="flex items-center gap-4 p-5 rounded-2xl transition-colors text-white border-r border-white/5">
                  ...
                  <div>
                    <p className="text-[9px] uppercase text-white/40 tracking-widest font-bold mb-0.5">
                      Date
                    </p>
                ...
                <div className="flex items-center gap-4 p-5 rounded-2xl transition-colors text-white">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold line-clamp-1 tracking-tight">
                      {event.location}
                    </p>
                  </div>
                </div>
            ...
            <Card
              variant="premium"
              className="p-10 md:p-14 border-white/5 bg-gradient-to-br from-white/[0.04] to-transparent backdrop-blur-3xl shadow-3xl"
            >
            ...
            <div className="pt-16 space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {suggestedEvents.map((item: SuggestedEvent, index: number) => (
                  <Card
                    key={item.id}
                    className="premium-card group border-0 overflow-hidden flex flex-col bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-500"
                  ...
                  >
                    ...
                    <CardHeader className="pb-1 px-5 pt-5">
                      <CardTitle className="text-sm text-white font-bold tracking-tight line-clamp-1 group-hover:text-[#FF3333] transition-colors">
                        {item.title}
                      </CardTitle>
                    </CardHeader>
                    <CardContent className="px-5 pb-5 flex-grow">
                      <p className="text-[10px] text-white/40 font-medium tracking-wide line-clamp-1 mb-4">
                        {item.location}
                      </p>
                      <Button
                        variant="premium"
                        className="w-full h-9 text-[10px] font-bold uppercase tracking-[0.2em] rounded-full"
                        asChild
                      >
          ...
          <div className="lg:col-span-4 relative">
            <Card
              className="sticky top-28 border-0 shadow-[0_30px_60px_-15px_rgba(0,0,0,1)] 
                            bg-gradient-to-b from-white/[0.04] to-transparent border-t border-white/10 
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  {event.ticketCategories.map((cat) => {
                    const isSoldOut = cat.quantityAvailable === 0;
                    return (
                      <div
                        key={cat.id}
                      ...
                      >
                        <div className="flex justify-between items-start">
                          <div className="space-y-1 text-white">
                            <h4 className="font-bold text-sm tracking-tight group-hover:text-[#FF3333] transition-colors">
                              {cat.name}
                            </h4>
                          ...
                          <span className="text-xl font-black premium-gradient-text">
                            ${cat.price}
                          </span>
                        </div>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            if (isSoldOut) {
                              setCreateError(
                                "Allocation is full. Please select another tier or try again later.",
                              );
                              return;
                            }
                            handleSelectTicket(cat);
                          }}
                        >
                          {creating
                            ? "Validating..."
