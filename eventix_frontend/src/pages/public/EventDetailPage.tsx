...
// import { MapPin, Calendar, Clock, ArrowLeft, ShieldCheck, Info, CalendarIcon } from "lucide-react";
...
// // Interface for the suggested events grid at the bottom
...
//       setError(null);
//       try {
//         // 1. Fetch current event detail
//         const data = await publicService.fetchEventDetail(Number(id));
//         setEvent(data);

//         // 2. Fetch suggested events for the bottom grid
...
//   if (loading) {
//     return (
//       <div className="premium-page-container flex items-center justify-center">
//         <div className="flex flex-col items-center gap-4">
//           <div className="w-12 h-12 border-4 border-[#FF3333]/20 border-t-[#FF3333] rounded-full animate-spin" />
//           <p className="text-[#FF3333] font-bold tracking-widest uppercase text-sm">Loading Experience...</p>
//         </div>
//       </div>
//     );
//   }
...
//   if (error || !event) {
//     return (
//       <div className="premium-page-container flex items-center justify-center text-center px-4">
//         <Card variant="premium" className="p-12 max-w-md">
//           <Info className="w-12 h-12 text-[#FF3333] mx-auto mb-4 opacity-50" />
//           <h2 className="text-2xl font-bold mb-4">{error || "Event not found."}</h2>
//           <Button variant="premium" onClick={() => navigate("/")}>Return to Gallery</Button>
//         </Card>
//       </div>
//     );
//   }
...
//   return (
//     <div className="premium-page-container pb-20 overflow-y-auto">
//       <div className="premium-bg-overlay" />

//       {/* Background Glow */}
//       <div className="absolute top-0 right-0 w-[50%] h-[50%] bg-[#FF3333]/5 rounded-full blur-[120px] pointer-events-none" />

//       {/* Hero Header */}
//       <div className="relative h-[45vh] min-h-[350px] w-full overflow-hidden">
//         {event.imageUrl ? (
//           <img src={event.imageUrl} className="w-full h-full object-cover brightness-50" alt={event.title} />
//         ) : (
//           <div className="absolute inset-0 bg-gradient-to-br from-[#330000] to-[#1A0000] flex items-center justify-center">
//             <Calendar className="h-24 w-24 text-[#FF3333]/10" />
//           </div>
//         )}
//         <div className="absolute inset-0 bg-gradient-to-t from-[#1A0000] via-transparent to-black/40" />

//         <div className="absolute top-8 left-8 z-20">
//           <button
//             onClick={() => navigate(-1)}
//             className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-[#FF3333]/20 backdrop-blur-md border border-white/10 rounded-xl transition-all group text-white"
//           >
...
//                 <div className="h-[2px] w-12 bg-[#FF3333]" />
//                 <span className="text-[#FF3333] font-bold uppercase tracking-[0.3em] text-xs">Premium Experience</span>
//               </div>
...
//               <div className="grid grid-cols-1 md:grid-cols-3 gap-2 p-1 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10">
//                 <div className="flex items-center gap-4 p-4 hover:bg-white/5 rounded-xl transition-colors text-white">
//                   <Calendar className="h-5 w-5 text-[#FF3333]" />
//                   <div>
//                     <p className="text-[10px] uppercase text-white/40 tracking-widest">Date</p>
...
//                   <div>
//                     <p className="text-[10px] uppercase text-white/40 tracking-widest">Time</p>
...
//                   <div>
//                     <p className="text-[10px] uppercase text-white/40 tracking-widest">Location</p>
...
//             <Card variant="premium" className="p-8 md:p-12 animate-fade-in-up delay-100 border-white/10">
//               <h2 className="text-2xl font-bold mb-6 flex items-center gap-3 text-white">
//                 <span className="w-1 h-6 bg-[#FF3333] rounded-full" />
//                 The Event Details
//               </h2>
//               <div className="text-white/60 leading-relaxed text-lg italic font-light">
//                 {event.description}
//               </div>
//             </Card>

//             {/* SUGGESTED EVENTS SECTION - NOW CORRECTED */}
//             <div className="pt-12 space-y-6">
//               <h3 className="text-2xl font-bold text-white tracking-tight">Suggested for You</h3>
...
//                       ) : (
//                         <div className="absolute inset-0 bg-gradient-to-br from-[#330000] to-[#1A0000] flex items-center justify-center">
//                           <CalendarIcon className="h-8 w-8 text-[#FF3333]/20" />
//                         </div>
//                       )}
//                       <div className="absolute top-3 right-3 bg-[#FF3333] text-white text-[10px] font-bold px-2 py-1 rounded shadow-lg">
//                         ${item.minPrice}+
//                       </div>
//                     </div>
//                     <CardHeader className="pb-2 px-4 pt-4">
//                       <CardTitle className="text-base text-black font-bold line-clamp-1">{item.title}</CardTitle>
//                     </CardHeader>
//                     <CardContent className="px-4 pb-4 flex-grow space-y-2">
//                       <p className="text-[11px] text-gray-500 line-clamp-2">{item.description}</p>
//                       <div className="flex items-center gap-2 text-[10px] font-semibold text-[#330000]">
//                         <MapPin className="h-3 w-3 text-[#FF3333]" />
//                         <span className="line-clamp-1">{item.location}</span>
//                       </div>
//                     </CardContent>
//                     <CardFooter className="px-4 pb-4 pt-0">
//                       <Button variant="premium" className="w-full h-8 text-[9px] uppercase" asChild>
...
//             <Card className="sticky top-24 border-0 shadow-2xl animate-fade-in-up delay-200 
//                             bg-[#250000] border-t border-white/10 overflow-hidden 
//                             w-full max-w-[340px] mx-auto lg:ml-auto ring-1 ring-white/5">

//               <CardHeader className="bg-black/40 border-b border-white/5 p-4">
//                 <div className="flex justify-between items-center mb-1">
//                   <CardTitle className="text-lg font-bold tracking-tight text-white">Passes</CardTitle>
//                   <ShieldCheck className="text-[#FF3333] h-4 w-4" />
//                 </div>
//                 <p className="text-[10px] text-white/40 uppercase tracking-widest">Secure Reservation</p>
//               </CardHeader>

//               <CardContent className="p-3">
//                 {createError && (
//                   <div className="mb-3 p-2 rounded bg-red-500/10 border border-red-500/20 text-red-500 text-[9px] text-center">
//                     {createError}
//                   </div>
//                 )}
//                 <div className="space-y-2">
//                   {event.ticketCategories.map((cat) => (
//                     <div key={cat.id} className="p-3 rounded-lg bg-white/5 border border-white/5 hover:bg-white/10 hover:border-[#FF3333]/40 transition-all flex flex-col gap-3 group">
//                       <div className="flex justify-between items-start">
//                         <div className="space-y-1 text-white">
//                           <h4 className="font-bold text-sm group-hover:text-[#FF3333] transition-colors">{cat.name}</h4>
//                           <span className="text-[9px] text-white/40 uppercase block">
//                             {cat.quantityAvailable} Available
//                           </span>
//                         </div>
//                         <span className="text-lg font-black premium-gradient-text">${cat.price}</span>
//                       </div>
//                       <Button variant="premium" className="w-full h-9 text-[10px] font-black uppercase tracking-widest"
//                         disabled={cat.quantityAvailable === 0 || creating} onClick={() => handleSelectTicket(cat)}>
//                         {cat.quantityAvailable > 0 ? (creating ? "..." : "Select Pass") : "Sold Out"}
//                       </Button>
//                     </div>
//                   ))}
//                 </div>
...
import { Button } from "../../components/ui/Button";
import { MapPin, Calendar, Clock, ArrowLeft, ShieldCheck, Info, CalendarIcon, Award, Sparkles } from "lucide-react";
import publicService from "../../service/publicService";
import {
  PublicEventDetailDTO,
  PublicTicketCategoryDTO,
