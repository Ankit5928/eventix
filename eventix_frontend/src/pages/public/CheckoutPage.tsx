      ...
      <div className="max-w-3xl mx-auto space-y-10 animate-fade-in-up">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-5xl font-bold tracking-tighter italic">
            Checkout <span className="text-[#FF0000]">Protocol</span>
          </h1>
        </div>
            ...
            return (
              ...
              >
                <div className="flex flex-col items-center gap-3">
                  <div
                    className={`w-12 h-12 rounded-2xl flex items-center justify-center border transition-all duration-500 ${
                      isActive
                        ? "bg-[#FF0000] border-[#FF0000] shadow-[0_0_20px_#FF0000]/30 text-white"
                        : isCompleted
                ...
                {i < stepLabels.length - 1 && (
                  <div
                    className={`flex-1 h-px mx-4 mt-[-20px] ${isCompleted ? "bg-green-500/20" : "bg-white/5"}`}
                  />
                )}
              </div>
            );
              ...
              <div className="space-y-6">
                ...
                <label className="flex items-start gap-4 p-4 bg-white/[0.01] border border-white/5 rounded-2xl cursor-pointer hover:bg-white/[0.03] transition-all group">
                  <input
                    ...
                    className="mt-1 h-4 w-4 rounded-lg bg-background border-white/10 text-[#FF0000] focus:ring-0 cursor-pointer"
                  />
                  <span className="text-[10px] text-white/40 uppercase font-bold tracking-wider leading-relaxed">
                    I acknowledge and authorize the{" "}
                    <a
                      href="#"
                      className="text-white underline decoration-[#FF0000]"
                    >
                      Deployment Terms
                    </a>{" "}
                ...
                <div className="flex justify-end pt-4">
                  <Button
                    ...
                    disabled={loading}
                    className="h-12 px-10 rounded-xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-[#FF0000]/20 border-0"
                  >
                    {loading ? (
              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                {summary ? (
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center p-8 bg-gradient-to-r from-[#FF0000]/10 to-transparent rounded-[2rem] border border-[#FF0000]/20 mt-10">
                      <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#FF0000]">
                  ...
                  <div className="h-40 flex items-center justify-center text-[10px] font-black uppercase tracking-[0.5em] text-white/10">
                    Decrypting...
                  </div>
                )}
                <div className="flex justify-between gap-4 pt-6">
                  <Button
                    ...
                    className="h-12 px-8 text-[9px] font-black uppercase tracking-widest text-white/40 hover:text-white"
                  >
                  ...
                  <Button
                    ...
                    disabled={loading}
                    className="h-12 px-10 rounded-xl font-black text-[10px] uppercase tracking-widest border-0"
                  >
                    {loading ? (
                      <Loader2 className="w-4 h-4 animate-spin" />
                    ) : (
                ...
                <div className="flex flex-col gap-6 pt-4">
                  ...
                  <div className="text-center p-4 rounded-2xl bg-white/[0.02] border border-white/5 flex items-center justify-center gap-3">
                    ...
                    <span className="text-[8px] font-black uppercase tracking-[0.3em] text-white/30">
                      Cleared via Secure Stripe Terminal
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className="text-center pb-20">
          <Link
            to="/"
            className="text-[9px] font-black uppercase tracking-[0.5em] text-white/10 hover:text-[#FF0000] transition-all flex items-center justify-center gap-2"
          >
